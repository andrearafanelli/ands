...
The main focus of my work is on the Neuro-Symbolic aspect of Artificial Intelligence, as well as the XAI (Explainable AI). As a result, the combination of Deep Learning models with logic-simbolic knowledge. The ultimate goal is to be able to integrate logic into neural systems, transforming them into intelligent agents with reasoning abilities. Furthermore, provide a higher level of trustworthiness, discoverability, and comprehension of such systems. 
